    ...
    <div>
      {pointer ? (
        ...
        <div className="min-h-[90vh] bg-purple-50 p-10">
          ...
          <div className="w-fit mx-auto">
            <button onClick={(e)=> setMed(e.target.textContent)} className="mx-5 hover:bg-purple-700 transiti ease-in font-semibold bg-purple-600 text-white px-5 py-2 rounded-lg">
              Yes
            </button>
            <button onClick={(e)=> setMed(e.target.textContent)} className="mx-5 hover:bg-purple-700 transiti ease-in font-semibold bg-purple-600 text-white px-5 py-2 rounded-lg">
              No
